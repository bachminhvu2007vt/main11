	...
	if (level > curLevel && level != 1) {
		...
		api.sendMessage(arrayContent, threadID, async function (error, info){
			if (global.configModule[moduleName].autoUnsend) {
				await new Promise(resolve => setTimeout(resolve, global.configModule[moduleName].unsendMessageAfter * 3000));
...
module.exports.languages = {
	"vi": {
		...
		"levelup": "{name} Tút tút tút........ Level up... Level < {level} > Cảm ơn bạn đã tương tác💗"
	},
	"en": {
		"on": "on",
		"off": "off",
