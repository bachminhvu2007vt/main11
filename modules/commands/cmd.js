    ...
    switch (args[0]) {
        ...
        case "info": {
            ...
            return api.sendMessage(
                ...
                "- 𝐶𝑜𝑑𝑒 𝑏𝑦: " + credits + "\n" +
                "- 𝑉𝑒𝑟𝑠𝑖𝑜𝑛: " + version + "\n" +
                "- 𝑃𝑒𝑟𝑚𝑖𝑠𝑠𝑖𝑜𝑛: " + ((hasPermssion == 0) ? "Người dùng" : (hasPermssion == 1) ? "Quản trị viên" : "Người vận hành bot" ) + "\n" +
                "- 𝐶𝑜𝑜𝑙𝑑𝑜𝑤𝑛𝑠: " + cooldowns + " giây(s)\n" +
                `- 𝐷𝑒𝑝𝑒𝑛𝑑𝑒𝑛𝑐𝑖𝑒𝑠: ${(Object.keys(dependencies || {})).join(", ") || "Không có"}`,
                threadID, messageID
            );
        }
        default: {
