...
module.exports.languages = {
	"vi": {
		...
		"banSuccess": "[ Ban User ] Đã ban xong một bé láo toét: %1🤡 ",
		"unbanSuccess": "[ Unban User ] Đã unban mụt bé đã bíc lỗi %1💗",
		...
		"returnBan": "[ Ban User ] Hãy ban nó🤡:\n- ID và tên người dùng cần ban: %1%2\n\n🖤 Reaction tin nhắn này để xác thực 🤍",
		"returnUnban": "[ Unban User ] Hãy unban nó🤡:\n- ID và tên người dùng cần ban: %1%2\n\n🖤 Reaction tin nhắn này để xác thực 🤍",
